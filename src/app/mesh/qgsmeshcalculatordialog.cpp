    ...
    mLayer( meshLayer )
{
  ...
  populateAvailableDatasetGroups();
  ...
  connect( useMaskCb, &QCheckBox::stateChanged, this, &QgsMeshCalculatorDialog::toogleExtendMask );
  connect( useExtentCb, &QCheckBox::stateChanged, this, &QgsMeshCalculatorDialog::toogleExtendMask );
...
void QgsMeshCalculatorDialog::toogleExtendMask( int state )
{
  Q_UNUSED( state );
...
void QgsMeshCalculatorDialog::populateAvailableDatasetGroups()
{
