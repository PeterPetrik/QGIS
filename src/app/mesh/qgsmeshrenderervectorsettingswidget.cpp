...

{
  ...
  mArrowSettingsWidget << mDisplayVectorsOnGridGroupBox << headOptionsGroupBox << generalOptionsGroupBox;
  mStreamlineSettingWidget << mStreamlineSeedingMethodGroupBox;
...
void QgsMeshRendererVectorSettingsWidget::syncToLayer( )
{
  ...
  mSymbologyVectorComboBox->setCurrentIndex( settings.displayingMethod() );
