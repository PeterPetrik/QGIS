...
QgsProviderMetadata::QgsProviderMetadata( const QString &_key, const QString &_description ):
  mKey( _key )
  , mDescription( _description )
{
...
QString QgsProviderMetadata::fileRasterFilters()
{
  return QString();
}

void QgsProviderMetadata::fileMeshFilters( QString &, QString & )
{
}

QString QgsProviderMetadata::fileVectorFilters()
{
  return QString();
}
