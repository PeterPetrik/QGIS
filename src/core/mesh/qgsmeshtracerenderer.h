 ...
 * \since QGIS 3.12
 */
class CORE_EXPORT QgsMeshStreamField
{
  public:
    ...
    //! Adds count random traces in the field from random start point, the number of traces depends on the max filling density
