...
QList<QgsDataItemGuiProvider *> *QgsOgrGuiProviderMetadata::dataItemGuiProviders()
{
  ...
  *providers
      << new QgsGeoPackageItemGuiProvider();
...
{
  QList<QgsProjectStorageGuiProvider *> *providers = new QList<QgsProjectStorageGuiProvider *>();

  *providers
      << new QgsGeoPackageProjectStorageGuiProvider();
