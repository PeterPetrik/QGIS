...
#ifndef QGSQUICKRUBBERBANDMODEL_H
#define QGSQUICKRUBBERBANDMODEL_H
...
class QUICK_EXPORT QgsQuickRubberbandModel : public QObject
{
  ...
  public:
    explicit QgsQuickRubberbandModel( QObject *parent = 0 );
...
#endif // QGSQUICKRUBBERBANDMODEL_H
